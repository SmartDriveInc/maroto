...
* The `v1` still exists in [this branch](https://github.com/SmartDriveInc/maroto/tree/v1), and you can see the doc [here](https://maroto.io/#/v1/README?id=deprecated).
...
[![Stargazers over time](https://starchart.cc/SmartDriveInc/maroto.svg?variant=adaptive)](https://starchart.cc/SmartDriveInc/maroto)
