...
import (
	extension "github.com/SmartDriveInc/maroto/v2/pkg/consts/extension"
	entity "github.com/SmartDriveInc/maroto/v2/pkg/core/entity"

	mock "github.com/stretchr/testify/mock"

	props "github.com/SmartDriveInc/maroto/v2/pkg/props"
)
...
// GetFpdf provides a mock function with no fields
func (_m *Provider) GetFpdf() interface{} {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetFpdf")
	}
...
// Provider_GetFpdf_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetFpdf'
type Provider_GetFpdf_Call struct {
	*mock.Call
}

// GetFpdf is a helper method to define mock.On call
func (_e *Provider_Expecter) GetFpdf() *Provider_GetFpdf_Call {
	return &Provider_GetFpdf_Call{Call: _e.mock.On("GetFpdf")}
}

func (_c *Provider_GetFpdf_Call) Run(run func()) *Provider_GetFpdf_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Provider_GetFpdf_Call) Return(_a0 interface{}) *Provider_GetFpdf_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Provider_GetFpdf_Call) RunAndReturn(run func() interface{}) *Provider_GetFpdf_Call {
	_c.Call.Return(run)
	return _c
}
