...
import (
	core "github.com/SmartDriveInc/maroto/v2/pkg/core"
...
func (_m *Maroto) GetProvider() core.Provider {
	ret := _m.Called()
...
// Maroto_GetProvider_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetProvider'
type Maroto_GetProvider_Call struct {
	*mock.Call
}

// GetProvider is a helper method to define mock.On call
func (_e *Maroto_Expecter) GetProvider() *Maroto_GetProvider_Call {
	return &Maroto_GetProvider_Call{Call: _e.mock.On("GetProvider")}
}

func (_c *Maroto_GetProvider_Call) Run(run func()) *Maroto_GetProvider_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *Maroto_GetProvider_Call) Return(_a0 core.Provider) *Maroto_GetProvider_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Maroto_GetProvider_Call) RunAndReturn(run func() core.Provider) *Maroto_GetProvider_Call {
	_c.Call.Return(run)
	return _c
}
